...
public class GameService {
    private static final String TOKEN = "Bearer qxw971i80yyacs52jige2j69kjsw75";
    private static final String CLIENT_ID = "1r029qcubkn9mfs23gsn17w8h34w2w";
    ...
    public Game searchGame(String gameName){
        ...
        String games = searchTwitch(url);
        List<Game> gameList = getGameList(games);
        if (gameList.size() != 0) {
